...
/**
 * Full-screen map of the player's CURRENT zone -- asteroid belts, stations,
 * portals, dungeons, cargo boxes and nearby ships, all to scale. Distinct
 * from the GalaxyMap (SocialPanel.tsx), which shows the sector-to-sector
 * overview for warping between zones. Toggled with M / showFullZoneMap.
 * Extracted from the old MiniMap.tsx so it keeps working after that
