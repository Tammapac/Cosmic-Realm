...
const ROTATION_FRAME_SHIPS: Set<string> = new Set(["skimmer", "wasp", "vanguard", "reaver", "obsidian", "marauder", "phalanx", "titan", "leviathan", "specter", "colossus", "harbinger", "eclipse", "sovereign", "apex"]);
