...
const SHIP_3D_MODELS: Record<string, string> = {
  ...
  enemy_scout: "/models/enemies/enemy_scout.glb?v=11",
  enemy_interceptor: "/models/enemies/enemy_interceptor.glb?v=11",
  enemy_raider: "/models/enemies/enemy_raider.glb?v=11",
  enemy_corvette: "/models/enemies/enemy_corvette.glb?v=11",
  enemy_destroyer: "/models/enemies/enemy_destroyer.glb?v=11",
  enemy_sentinel: "/models/enemies/enemy_sentinel.glb?v=11",
  enemy_specter: "/models/enemies/enemy_specter.glb?v=11",
  enemy_phantom: "/models/enemies/enemy_phantom.glb?v=11",
  enemy_wraith: "/models/enemies/enemy_wraith.glb?v=11",
  enemy_voidling: "/models/enemies/enemy_voidling.glb?v=11",
  enemy_dread: "/models/enemies/enemy_dread.glb?v=11",
  enemy_titan: "/models/enemies/enemy_titan.glb?v=11",
  enemy_juggernaut: "/models/enemies/enemy_juggernaut.glb?v=11",
  enemy_overlord: "/models/enemies/enemy_overlord.glb?v=11",
  enemy_leviathan: "/models/enemies/enemy_leviathan.glb?v=11",
  // Zengas — x-4 tier ship, registered and render-ready (not yet mapped to a type)
  enemy_zengas: "/models/enemies/enemy_zengas.glb?v=11",
};
