...
const SHIP_3D_MODELS: Record<string, string> = {
  ...
  enemy_scout: "/models/enemies/enemy_scout.glb?v=13",
  enemy_interceptor: "/models/enemies/enemy_interceptor.glb?v=13",
  enemy_raider: "/models/enemies/enemy_raider.glb?v=13",
  enemy_corvette: "/models/enemies/enemy_corvette.glb?v=13",
  enemy_destroyer: "/models/enemies/enemy_destroyer.glb?v=13",
  enemy_sentinel: "/models/enemies/enemy_sentinel.glb?v=13",
  enemy_specter: "/models/enemies/enemy_specter.glb?v=13",
  enemy_phantom: "/models/enemies/enemy_phantom.glb?v=13",
  enemy_wraith: "/models/enemies/enemy_wraith.glb?v=13",
  ...
  enemy_leviathan: "/models/enemies/enemy_leviathan.glb?v=16",
