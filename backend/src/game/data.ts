...
export const ENEMY_DEFS: Record<EnemyType, {
  ...
  dread: {
    ...
    hullMax: 850, damage: 55, speed: 70, exp: 100, credits: 350, honor: 12,
  ...
  titan: {
    ...
    hullMax: 1500, damage: 75, speed: 65, exp: 150, credits: 500, honor: 18,
    color: "#ff2244", size: 30,
    loot: { resourceId: "dread", qty: 4 },
  },
  overlord: {
    type: "overlord", behavior: "tank",
    hullMax: 2200, damage: 95, speed: 50, exp: 250, credits: 800, honor: 30,
