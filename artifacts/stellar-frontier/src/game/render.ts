...
function drawEnemy(ctx: CanvasRenderingContext2D, e: Enemy): void {
  ...
  const hi = "#ffffff";
  const s = e.size / 10;
  const pulse = 1 + Math.sin(state.tick * 5 + e.id.charCodeAt(0)) * 0.05;
  if (e.type === "scout") {
    ctx.fillStyle = c;
    ctx.beginPath();
    ctx.ellipse(0, -1.5 * s, 5.5 * s * pulse, 8.5 * s * pulse, 0, 0, Math.PI * 2);
    ctx.fill();
    ctx.fillStyle = dk;
    ctx.beginPath();
    ctx.ellipse(0, 4.5 * s, 4.5 * s * pulse, 4 * s, 0, 0, Math.PI * 2);
    ctx.fill();
    ctx.fillStyle = hi;
    ctx.beginPath();
    ...
    ctx.quadraticCurveTo(-8 * s, -6 * s, -10 * s, -1 * s);
    ctx.quadraticCurveTo(-7 * s, 2 * s, -4 * s, 1 * s);
    ctx.fill();
    ctx.beginPath();
    ctx.moveTo(4.5 * s, -2 * s);
    ctx.quadraticCurveTo(8 * s, -6 * s, 10 * s, -1 * s);
    ...
    ctx.quadraticCurveTo(-9 * s, -4 * s, -8 * s, 3 * s);
    ctx.quadraticCurveTo(-4 * s, 11 * s, 0, 10 * s);
    ctx.quadraticCurveTo(4 * s, 11 * s, 8 * s, 3 * s);
    ctx.quadraticCurveTo(9 * s, -4 * s, 0, -10 * s);
    ctx.fill();
    ctx.fillStyle = dk;
    ctx.beginPath();
    ctx.moveTo(-7 * s, 0);
    ctx.quadraticCurveTo(-12 * s, 3 * s, -9 * s, 7 * s);
    ctx.quadraticCurveTo(-5 * s, 5 * s, -4 * s, 1 * s);
    ctx.fill();
    ctx.beginPath();
    ctx.moveTo(7 * s, 0);
    ctx.quadraticCurveTo(12 * s, 3 * s, 9 * s, 7 * s);
    ...
    ctx.fillStyle = hi;
    ctx.beginPath();
    ctx.ellipse(0, -2 * s, 1.5 * s, 2.5 * s, 0, 0, Math.PI * 2);
    ctx.fill();
  } else if (e.type === "destroyer") {
    ctx.fillStyle = c;
    ctx.beginPath();
    ctx.moveTo(0, -12 * s * pulse);
    ctx.quadraticCurveTo(-9 * s, -9 * s, -12 * s, -1 * s);
    ctx.quadraticCurveTo(-14 * s, 8 * s, -4 * s, 11 * s);
    ctx.quadraticCurveTo(0, 14 * s, 4 * s, 11 * s);
    ctx.quadraticCurveTo(14 * s, 8 * s, 12 * s, -1 * s);
    ctx.quadraticCurveTo(9 * s, -9 * s, 0, -12 * s);
    ctx.fill();
    ctx.fillStyle = dk;
    ctx.beginPath();
    ctx.moveTo(-10 * s, 1 * s);
    ctx.quadraticCurveTo(-16 * s, 2 * s, -11 * s, 9 * s);
    ctx.quadraticCurveTo(-7 * s, 5 * s, -7 * s, 1 * s);
    ctx.fill();
    ctx.beginPath();
    ctx.moveTo(10 * s, 1 * s);
    ctx.quadraticCurveTo(16 * s, 2 * s, 11 * s, 9 * s);
    ...
    ctx.fillStyle = hi;
    ctx.beginPath();
    ctx.arc(0, -2.5 * s, 2.2 * s, 0, Math.PI * 2);
    ctx.fill();
    ...
    ctx.quadraticCurveTo(8 * s, -10 * s, 10 * s, -2 * s);
    ctx.quadraticCurveTo(12 * s, 7 * s, 3 * s, 11 * s);
    ctx.quadraticCurveTo(0, 13 * s, -3 * s, 11 * s);
    ctx.quadraticCurveTo(-12 * s, 7 * s, -10 * s, -2 * s);
    ctx.quadraticCurveTo(-8 * s, -10 * s, 0, -11 * s);
    ctx.fill();
    ctx.fillStyle = dk;
    ctx.beginPath();
    ctx.ellipse(-5 * s, -1 * s, 2.5 * s, 4.5 * s, -0.4, 0, Math.PI * 2);
    ctx.fill();
    ctx.beginPath();
    ctx.ellipse(5 * s, -1 * s, 2.5 * s, 4.5 * s, 0.4, 0, Math.PI * 2);
    ctx.fill();
    ctx.fillStyle = hi;
    ctx.beginPath();
    ctx.ellipse(0, -1 * s, 3 * s, 4 * s, 0, 0, Math.PI * 2);
    ctx.fill();
    ...
    ctx.beginPath();
    ctx.moveTo(-8 * s, 5 * s);
    ctx.quadraticCurveTo(-13 * s, 8 * s, -12 * s, 12 * s);
    ctx.moveTo(8 * s, 5 * s);
    ctx.quadraticCurveTo(13 * s, 8 * s, 12 * s, 12 * s);
    ctx.stroke();
  } else {
    // dread — huge alien leviathan
    ctx.fillStyle = c;
    ctx.beginPath();
    ctx.moveTo(0, -15 * s * pulse);
    ctx.quadraticCurveTo(12 * s, -11 * s, 16 * s, -2 * s);
    ctx.quadraticCurveTo(18 * s, 7 * s, 11 * s, 12 * s);
    ctx.quadraticCurveTo(5 * s, 15 * s, 0, 13 * s);
    ctx.quadraticCurveTo(-5 * s, 15 * s, -11 * s, 12 * s);
    ctx.quadraticCurveTo(-18 * s, 7 * s, -16 * s, -2 * s);
    ctx.quadraticCurveTo(-12 * s, -11 * s, 0, -15 * s);
    ctx.fill();
    ctx.fillStyle = dk;
    ctx.beginPath();
    ctx.ellipse(-8 * s, 1 * s, 4 * s, 6 * s, -0.2, 0, Math.PI * 2);
    ctx.fill();
    ctx.beginPath();
    ctx.ellipse(8 * s, 1 * s, 4 * s, 6 * s, 0.2, 0, Math.PI * 2);
    ctx.fill();
    ...
    ctx.beginPath();
    ctx.ellipse(0, -2 * s, 4 * s, 7 * s, 0, 0, Math.PI * 2);
    ctx.fill();
    ctx.fillStyle = hi;
    ctx.beginPath();
